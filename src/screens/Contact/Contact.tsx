              ...
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full bg-[#ee0faf] hover:bg-[#ee0faf]/90 text-white py-3 text-lg font-medium flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      'Sending...'
                    ) : (
                  ...
                  <Card className="bg-[#1e1e1e] border-none hover:bg-[#2a2a2a] transition-colors duration-300">
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div className="text-[#ee0faf] mt-1">
                          {item.icon}
                        </div>
                        <div>
                          <h3 className="text-white font-semibold mb-1">{item.title}</h3>
                          <p className="text-[#ee0faf] font-medium mb-1">{item.info}</p>
