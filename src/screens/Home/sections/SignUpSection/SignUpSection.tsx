...
export const SignUpSection = (): JSX.Element => {
  ...
  return (
    <motion.nav 
      ...
      className="sidebar-scroll flex flex-col w-full max-w-[30%] lg:max-w-[320px] items-start gap-6 pl-4 lg:pl-16 pr-4 lg:pr-8 pt-12 pb-12 bg-[#0e010b] border-r-2 [border-right-style:solid] border-[#ee0faf] shadow-[8px_0px_24.2px_#ee0faf26] h-screen fixed left-0 top-0 z-50 overflow-y-auto"
    >
      <motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
          ...
          >
            <Link to={item.path}>
              ...
              >
                ...
                <span
                  className={`flex-1 h-7 font-[number:var(--h3-font-weight)] text-[length:var(--h3-font-size)] tracking-[var(--h3-letter-spacing)] mt-[-1.00px] font-h3 leading-[var(--h3-line-height)] [font-style:var(--h3-font-style)] text-left ${
        ...
        >
          <Link to={
            ...
            >
              {item.icon}
              <span
                className={`flex-1 h-[23px] mt-[-1.00px] font-h4 font-[number:var(--h4-font-weight)] text-[length:var(--h4-font-size)] tracking-[var(--h4-letter-spacing)] leading-[var(--h4-line-height)] [font-style:var(--h4-font-style)] text-left ${
                  item.isSpecial ? "text-[#0d9eef]" : "text-white"
                }`}
              >
                {item.label}
